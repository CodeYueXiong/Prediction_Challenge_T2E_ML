...
##############################################################
##########    Step 1: Default training set as d2    ##########
##############################################################
...
## create the corresponding task as for dataframe 2
tsks_train_d2 <- TaskSurv$new("df2", backend = train_data_original[[2]], time = "time", event = "status")
...
## method 2: Automating the Feature Selection
library("paradox")
remotes::install_github("mlr-org/mlr3fselect", force = TRUE)
library("mlr3fselect")
remotes::update_packages("mlr3tuning")
